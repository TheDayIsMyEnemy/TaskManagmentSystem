    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("TaskManagmentSystem.Web"),
                _urlEncoder.Encode(email),
                unformattedKey);
        }

        private async System.Threading.Tasks.Task LoadSharedKeyAndQrCodeUriAsync(User user, EnableAuthenticatorViewModel model)
        {
